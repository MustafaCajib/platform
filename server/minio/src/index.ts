...
import { type StorageAdapter, type StorageConfig } from '@hcengineering/server-core'
...
export class MinioService implements StorageAdapter {
  ...
  async list (ctx: MeasureContext, workspaceId: WorkspaceId, prefix?: string): Promise<Blob[]> {
    try {

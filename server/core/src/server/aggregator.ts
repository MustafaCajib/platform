...
import { type StorageAdapter, type UploadedObjectInfo } from '../storage'
...
export class AggregatorStorageAdapter implements StorageAdapter {
  ...
  async list (ctx: MeasureContext, workspaceId: WorkspaceId, prefix?: string | undefined): Promise<Blob[]> {
